...
const mock = [
  {
    ...
    summary: '60 – 90 minute community session on brain formation stages, developmental areas, protective/promoting/risk factors and regression.',
  ...
  },
  {
    ...
    audience: 'For Parents',
    summary: '90 – 120 minute interactive session to understand what is autism, it’s prevalence, diagnosis, symptoms, causes & more factors needed to manage the condition',
...

  {
    ...
    audience: 'For Parents',
    summary: '90 – 120 minute interactive session to understand picky eating and fussy behavior patterns in autism, and how parents can help their child’s development journey.',
...

  {
    ...
    audience: 'For Parents',
    summary: '90 – 120 minute interactive session to understand schooling for special needs child works, and how to get it right.',
