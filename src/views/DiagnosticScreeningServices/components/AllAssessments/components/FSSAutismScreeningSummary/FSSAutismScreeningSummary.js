...
const mock = [
  {
    ...
    headerSlide: 'Autism screening needs urgency & confirmation',
    avatar: 'https://assets.maccarianagency.com/backgrounds/img5.jpg',

    subSlideLine1:'Autism can reliably be diagnosed by age 2, but the average age of diagnosis in the U.S. is about 5 years old.',
    subSlideLine2:'For effective detection, screening must be done for all children – not only those with symptoms. ',
    subSlideLine3:'Also, many diagnosis tools should be used, not just one.',
    subSlideLine4:'',
    subSlideLine5:'',

    headerBodySlide:'Our recommended top tools are:',
    
    
    bodySlideLine1:'Modified Checklist for Autism in Toddles – Revised (M-CHAT-R),',
    bodySlideLine2:'Autism Diagnosis Interview – Revised (ADI-R)',
    bodySlideLine3:'Autism Diagnostic Observation Schedule – Generic (ADOS-G)',
    bodySlideLine4:'Childhood Autism Rating Scale (CARS)',
    bodySlideLine5:'Gilliam Autism Rating Scale – 2nd Edition (GARS-2)',
...
const FSSAutismScreeningSummary = () => {
            ...
            <Container>
              <Box display={'flex'} flexDirection={'column'} justifyItems={'left'} alignContent={'flex-start'}>
                ...
                <Typography
                  ...
                  data-aos={'fade-up'}
                >
                  Early Detection of autism boosts the impact of therapy on your child
                </Typography>
...
export { FSSAutismScreeningSummary };
