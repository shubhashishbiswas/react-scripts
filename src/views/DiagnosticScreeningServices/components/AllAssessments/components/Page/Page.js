...
import {  PageHeaderDiagnostics } from './components';

const pages = [
  
  {
    id: 'Autism',
    href: '#ANCHOR_Diagnostics_Autism',
    title: 'Autism Spectrum Disorder',
    imageIcon: 'https://images.news18.com/ibnlive/uploads/2021/09/childautism-163048404816x9.png'
  },
  
  {
    id: 'FunctionalBehavior',
    href: '#ANCHOR_Diagnostics_FuncBehavior',
  ...
  {
    id: 'DevelopmentalSkillDeficit',
    href: '#ANCHOR_Diagnostics_SkillDef',
    title: 'Developmental Skill Deficit',
