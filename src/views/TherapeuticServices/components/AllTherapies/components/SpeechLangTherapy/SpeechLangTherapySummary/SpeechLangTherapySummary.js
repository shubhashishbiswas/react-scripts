...
const SpeechLangTherapySummary = () => {
    ...
    >
      ...
      >
        <Box
          ...
          sx={styles(
            'https://www.theschoolrun.com/sites/theschoolrun.com/files/article_images/speech_and_language_therapy_for_kids.jpg',
            ...
            <Container>
              <Box>
                ...
                <Typography
                  ...
                  data-aos={'fade-up'}
                >
                  Manage speech and language delays of your child with us 
                </Typography>
...
export { SpeechLangTherapySummary };