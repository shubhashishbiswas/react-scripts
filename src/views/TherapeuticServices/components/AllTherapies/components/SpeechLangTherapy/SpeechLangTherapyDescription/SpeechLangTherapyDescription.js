...
const mock = [
  {
    ...
    headerSlide: 'Why is Speech & Language therapy needed?',
    avatar: 'https://mind.help/wp-content/uploads/2021/12/Types-of-Communication-Disorders.jpg',

    subSlideLine1:'Speech and language delays tend to be among parents’ earliest developmental concerns.',
    subSlideLine2:'Speech & Language therapy is perceived as supporting the literal act of speaking.',
    subSlideLine3:'It has other important aspects like comprehension, clarity, voice, fluency, and sound production.',
    subSlideLine4:'',
    subSlideLine5:'',
    
    headerBodySlide:'Our program helps with:',
    
    bodySlideLine1:'PracReceptive and expressive communication challenges',
    bodySlideLine2:'Oral motility concerns – chewing, swallowing etc.',
    bodySlideLine3:'Voice fluency, articulation and social language skills.',
    bodySlideLine4:'',
    bodySlideLine5:'',
...
const SpeechLangTherapyDescription = () => {
...
export { SpeechLangTherapyDescription };
