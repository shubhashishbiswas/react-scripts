...
const mock = [
  {
    ...
    headerSlide: 'Why is Feeding Therapy needed?',
    avatar: 'https://miro.medium.com/max/1400/0*px1WbpX4R-BgvkS8',

    subSlideLine1:'Feeding Therapy teaches children and parents how to not only eat and eat better but also eating an enjoyable experience.',
    subSlideLine2:'',
    subSlideLine3:'',
    subSlideLine4:'',
    subSlideLine5:'',
    ...
    bodySlideLine1:'Picky eating by exploring new foods, new textures for kids with sensory challenges',
    bodySlideLine2:'Improving coordination – chewing, swallowing, and eating',
    bodySlideLine3:'Improving oral motor skills',
    bodySlideLine4:'Tasting foods your child normally wouldn’t on their own',
    bodySlideLine5:'',
...

  {
    ...
    avatar: 'https://kimpediatrics.com/wp-content/uploads/2022/08/Ivy-Promo-images-final-43a-scaled.jpg',
    ...
    headerBodySlide:'Our program helps your child:',
...
const FeedingTherapyDescription = () => {
...
export { FeedingTherapyDescription };
