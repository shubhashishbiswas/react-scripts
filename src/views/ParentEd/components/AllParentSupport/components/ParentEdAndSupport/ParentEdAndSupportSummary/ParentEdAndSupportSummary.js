...
const ParentEdAndSupportSummary = () => {
    ...
    >
      ...
      >
        <Box
          ...
          sx={styles(
            'https://www.calmsage.com/wp-content/uploads/2020/12/Parenting-therapy.jpg',
          )}
        />
          ...
          >
            <Container>
              <Box>
                ...
                >
                  Educating parents for the best developmental outcomes
                </Typography>
                ...
                <Typography
                  ...
                  data-aos={'fade-up'}
                >
                  Understanding a special needs child needs far more 
                  <br />than regular parental love and care. Explore our parent education offerings
                </Typography>
...
export { ParentEdAndSupportSummary };