...
const mock = [
  {
    ...
    headerSlide: 'Why is Parent Ed needed?',
    avatar: 'https://www.seekfreaks.com/wp-content/uploads/2018/03/5-Tips-Therapist-and-Parent-Autism-945x950.png',

    subSlideLine1:'Parents both nurture and nourish a child by creating a conducive environment to ensure a healthy and happy childhood',
    subSlideLine2:'It is essential to have early awareness of early signs of possible delays observed in the time course of your child’s development. ',
    subSlideLine3:'Arming yourself with the right information allows you to advance both investigation and intervention of possible developmental delays.',
    subSlideLine4:'',
    subSlideLine5:'',
...

  {
    ...
    headerSlide: 'Why choose SimSouls for Parent Education services?',
    avatar: 'https://www.goodtherapy.org/admin/includes/ckfinder/userfiles/images/counselor-listens-to-client.jpg',
    ...
    headerBodySlide:'Our program helps you to:',
    
    bodySlideLine1:'Comprehensive content in all media formats to cover at your own pace',
    bodySlideLine2:'Regular updates to keep you up-to-date as your child grows',
    bodySlideLine3:'Get answers to all your questions and concerns at all stages of your child’s growth',
    bodySlideLine4:'Get preferred access to our experts that give specific, authentic directions',
...
const ParentEdAndSupportDescription = () => {
...
export { ParentEdAndSupportDescription };
