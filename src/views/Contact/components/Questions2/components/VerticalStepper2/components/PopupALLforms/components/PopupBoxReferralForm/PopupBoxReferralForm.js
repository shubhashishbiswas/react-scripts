...
import { FormReferralInfo } from './components'; 

const PopupBoxReferralForm = ({ onClose, open }) => {
  ...
  return (
    ...
    >
      ...
      < FormReferralInfo onClose={onClose} />
...
PopupBoxReferralForm.propTypes = {
  onClose: PropTypes.func.isRequired,
  open: PropTypes.bool.isRequired,
};

export { PopupBoxReferralForm };
