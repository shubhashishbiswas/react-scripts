...
import { FormPatientInfo } from './components'; 


const PopupBoxPatientForm = ({ onClose, open }) => {
  ...
  return (
    ...
    >
      < FormPatientInfo onClose={onClose} />
      {/* < FormInsurerInfo />  */}
...
PopupBoxPatientForm.propTypes = {
  onClose: PropTypes.func.isRequired,
  open: PropTypes.bool.isRequired,
};

export { PopupBoxPatientForm };
